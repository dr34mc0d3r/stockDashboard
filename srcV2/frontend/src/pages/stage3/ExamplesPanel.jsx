// The Stage 3 Examples section: preset cards that load a hyperparameter
// combination AND an indicator selection with one click.
  ...
  return (
    <>
      <p className="mb-4 text-sm text-slate-400">
        Presets pairing hyperparameters with an indicator set, each tuned to surface a specific
        lesson. <strong>Apply</strong> loads both into the form below.
      </p>
